...
<p align="left">
  <img src="./images/01-concept/concept.png" alt="Concept" width="1135">
</p>
...
<p align="left">
  <img src="./images/01-concept/housing.png" alt="Housing" width="650"> 
</p>
...
<p align="left">
  <img src="./images/01-concept/separation-top.png" alt="Separation top" width="672">
</p>
...
<p align="left">
  <img src="./images/01-concept/separation-bottom.png" alt="Separation bottom" width="595">
</p>
...
<p align="left">
  <img src="./images/01-concept/housing-bottom.png" alt="Housing bottom" width="799">
</p>
...
<p align="left">
  <img src="./images/03-maintaining-colors/result.png" alt="Result" width="739"> 
</p>
...
<p align="left">
  <img src="./images/03-maintaining-colors/different-orientations.png" alt="Different orientations" width="879">
</p>
...
<p align="center">
  <img src="./images/05-skeleton-body/sketches-in-skeleton.png" alt="Sketches in skeleton" width="497">
</p>
...
<p align="center">
  <img src="./images/05-skeleton-body/shape-binders.png" alt="Shape binders" width="500">
</p>
...
<p align="center">
  <img src="./images/05-skeleton-body/define-first-datumplane.png" alt="Define first datumplane" width="1263">
</p>
...
<p align="center">
  <img src="./images/05-skeleton-body/drawing-base-sketch.png" alt="Drawing base sketch" width="817">
</p>
...
<p align="center">
  <img src="./images/05-skeleton-body/extrude-up-to-the-next-plane.png" alt="Extrude up to the next plane" width="787">
</p>
...
<p align="center">
  <img src="./images/05-skeleton-body/adding-sketches-to-skeleton.png" alt="Adding sketches to skeleton" width="870">
</p>
...
<p align="center">
  <img src="./images/05-skeleton-body/sk-rim-trj.png" alt="Sk rim trj" width="553">
</p>

To make such references, switch to ISO view:

<p align="center">
  <img src="./images/05-skeleton-body/referencing-in-iso-view.png" alt="Referencing in iso view" width="710">
</p>

The finish the **Housing** body:

<p align="center">
  <img src="./images/05-skeleton-body/housing-completed.png" alt="Housing completed" width="797">
</p>
...
<p align="center">
  <img src="./images/05-skeleton-body/separation-bottom-shape-binders.png" alt="Separation bottom shape binders" width="665">
</p>

This is wat **Separation bottom** looks like when it is completed:

<p align="center">
  <img src="./images/05-skeleton-body/separation-bottom-completed.png" alt="Separation bottom completed" width="658">
</p>

**Separation top** is very similar:

<p align="center">
  <img src="./images/05-skeleton-body/separation-top-completed.png" alt="Separation top completed" width="731">
</p>

The final result looks like this:

<p align="center">
  <img src="./images/05-skeleton-body/final-result-original-closed.png" alt="Final result original closed" width="800">
</p>

And with the top off:

<p align="center">
  <img src="./images/05-skeleton-body/final-result-original.png" alt="Final result original" width="733">
</p>
...
<p align="center">
  <img src="./images/05-skeleton-body/result-after-changes.png" alt="Result after changes" width="724">
</p>

<p align="center">
  <img src="./images/05-skeleton-body/result-after-changes-open.png" alt="Result after changes open" width="710">
</p>
...
<p align="center">
  <img src="./images/06-check-model/persistent-section-cut.png" alt="Persistent section cut" width="548">
</p>
...
<p align="center">
  <img src="./images/06-check-model/slicing.png" alt="Slicing" width="1075">
</p>
...
<p align="center">
  <img src="./images/07-referencing-components/import-components.png" alt="Import components" width="853">
</p>
...
<p align="center">
  <img src="./images/07-referencing-components/references-to-components.png" alt="References to components" width="847">
</p>

Create the sketches in the **Skeleton** body. 

<p align="center">
  <img src="./images/07-referencing-components/sketches-in-skeleton.png" alt="Sketches in skeleton" width="877">
</p>

Create the **Housing**, **Separation top**, **Separation bottom**, **Housing top** and **Housing bottom** like in the previous example.

<p align="center">
  <img src="./images/07-referencing-components/final-housing-bottom.png" alt="Final housing bottom" width="1260">
</p>

<p align="center">
  <img src="./images/07-referencing-components/final-housing-total.png" alt="Final housing total" width="1263">
</p>
...
<p align="center">
  <img src="./images/08-self-tapping-screws/self-tapping-screws.png" alt="Self tapping screws" width="150">
</p>
...
<p align="center">
  <img src="./images/08-self-tapping-screws/additional-sketch.png" alt="Additional sketch" width="1105">
</p>

<p align="left">
  <img src="./images/08-self-tapping-screws/warning.png" alt="Warning 1" height="35">
</p>

<p align="left">
  <img src="./images/08-self-tapping-screws/warning2.png" alt="Warning 2" height="35">
</p>
...
<p align="center">
  <img src="./images/08-self-tapping-screws/create-datum-plane.png" alt="Create datum plane" width="865">
</p>
...
<p align="center">
  <img src="./images/08-self-tapping-screws/create-sketch.png" alt="Create sketch" width="332">
</p>

6. Create a Groove **HS Screw hole 1** based on this sketch, choosing the construction line as a centerline.

<p align="center">
  <img src="./images/08-self-tapping-screws/create-groove.png" alt="Create groove" width="808">
</p>
...
<p align="center">
  <img src="./images/08-self-tapping-screws/alignment-of-pillar-height.png" alt="Alignment of pillar height" width="620">
</p>
...
<p align="center">
  <img src="./images/08-self-tapping-screws/datum-plane-in-separation-bottom.png" alt="Datum plane in separation bottom" width="1090">
</p>
...
<p align="center">
  <img src="./images/08-self-tapping-screws/screw-pillar-sketch-in-separation-bottom.png" alt="Screw pillar sketch in separation bottom" width="568">
</p>
...
<p align="center">
  <img src="./images/08-self-tapping-screws/separation-bottom-with-pillars.png" alt="Separation bottom with pillars" width="748">
</p>

Also repeat the procedure to create the holes in **Separation top**.

<p align="center">
  <img src="./images/08-self-tapping-screws/screw-holes-in-separation-top.png" alt="Screw holes in separation top" width="735">
</p>

The changes will now automatically come through in both housing parts:

<p align="center">
  <img src="./images/08-self-tapping-screws/housing-completed.png" alt="Housing completed" width="670">
</p>
