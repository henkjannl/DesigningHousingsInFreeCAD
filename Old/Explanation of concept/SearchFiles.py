...
#START_LOCATION = r'C:\Users\henkj\OneDrive\03 HenkJan'
#START_LOCATION = r'D:\GDrive\Takeout\Drive\03 HenkJan'
#START_LOCATION = r'C:\Users\hjvanderpol\OneDrive\03 HenkJan\18 FreeCad'
#START_LOCATION = r'C:\Users\hjvanderpol\OneDrive - Bond High Performance 3D Technology\Presentations'
...
def Requirement(direntry):
	...
	#return 'slicer' in direntry.path.lower() and direntry.name.lower().endswith('pptx') 
	...
	#return (not direntry.is_dir()) and (100*int(datetime.fromtimestamp(direntry.stat().st_ctime).strftime('%Y%m'))>202010)
